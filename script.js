                ...
                S = P(function (t) {
                    ...
                    (t.init = function (o, p, x, K) {
                        ...
                        x[2] && (c = x[2]),
                            ...
                            (this.angle =
                                K.angle || this.angle || et.defaultAngle),
...
`);
                    ...
                    if (V) {
                        if (!d.test(V))
                            throw new Error(
                                'variable is not a bare identifier: ' + V
                            );
                    } else
                        (k =
                            `with(obj||{}){
    ...
    var oe = lt((Re, re) => {
        ...
        Bt.define(
            ...
            (re.exports = function (e, y, l) {
                ...
                function H(E, m, M) {
                    throw (
                        (console.error('Could not load editor script: ' + m), M)
                    );
                }
                function $(E) {
                    return E.indexOf('//') >= 0
                ...
                function e(l) {
                    ...
                    function P(f) {
                        f.metaKey ||
                            f.altKey ||
                            f.ctrlKey ||
                            (_(l.activeElement) && B(l.activeElement),
                            (T = !0));
                    }
                    function R() {
                        T = !1;
                    ...
                    function b(f) {
                        (f.target.nodeName &&
                            f.target.nodeName.toLowerCase() === 'html') ||
                            ((T = !1), q());
                    }
            ...
            (le.exports = function (e, y) {
                ...
                function X(q) {
                    if (!q.getAttribute('hreflang')) {
                        var b =
                            (C && q.getAttribute('href-disabled')) ||
                            q.getAttribute('href');
                ...
                function $(q, b, f) {
                    ...
                    (f && E) ||
                        (!f && !E) ||
                        (f ? q.addClass(b) : q.removeClass(b));
                }
                return l;
            })
        );
                ...
                function it(d, a, u) {
                    ...
                    return (
                        L.add(d).each(function (h, F) {
                            var k = parseFloat(
                                F.getAttribute('data-scroll-time')
                            );
                            !isNaN(k) && k >= 0 && (v = k);
                        }),
